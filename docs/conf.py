...
pkg_dir = os.path.join(source_dir, '..', '..', 'src', 'dicomslide')
sys.path.insert(0, os.path.abspath(pkg_dir))

# -- Project information -----------------------------------------------------

project = 'dicomslide'
copyright = '2022, Herrmann Lab'
author = 'Markus D. Herrmann'

# The full version, including alpha/beta/rc tags
try:
    release = pkg_resources.get_distribution('dicomslide').version
except pkg_resources.DistributionNotFound:
    print('Package "dicomslide" must be installed to build docs.')
    sys.exit(1)
...
htmlhelp_basename = 'dicomslidedoc'
...
texinfo_documents = [
    (
        ...
        (
            ...
            'efficiently via DICOMweb services.'
        ),
        'Miscellaneous'
    ),
]
